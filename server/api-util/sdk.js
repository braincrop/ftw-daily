...
const CLIENT_ID_INTEGRATION = process.env.REACT_APP_SHARETRIBE_INTEGRATION_SDK_CLIENT_ID;
const CLIENT_SECRET_INTEGRATION = process.env.REACT_APP_SHARETRIBE_INTEGRATION_SDK_CLIENT_SECRET;
